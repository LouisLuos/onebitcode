function sendSpaceship(name, capitain) {
    ...
    alert("A nave ".concat(spaceship.name, " com os tripulantes ").concat(spaceship.crew.forEach(function (pessoa) { return console.log(pessoa); }), " foram enviados a uma miss\u00E3o a bordo do capit\u00E3o ").concat(spaceship.capitain));
    return spaceship;
}
