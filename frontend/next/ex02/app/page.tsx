  ...
  return (
    <article className={styles.post}>
      ...
      <div className={`${styles.postContent}`}>
        <Image src="/image.png" alt="Saturno no espaço" width={600} height={307} />
        <p>
        ...
        <Image src="/image.png" alt="Anéis de Saturno" width={600} height={328} />
        ...
        <Image src="/image.png" alt="Luas de Saturno" width={600} height={315} />
      </div>
